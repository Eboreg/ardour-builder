...
RUN apt-get install -y autoconf automake bzip2 chrpath cmake g++ gcc git intltool itstool libarchive-dev \
    libasound2-dev libaubio-dev libbison-dev libboost-dev libcairo2-dev libcairomm-1.16-dev libcppunit-dev \
    libcurl4-gnutls-dev libexpat1-dev libffi-dev libfftw3-dev libflac-dev libfontconfig-dev libfreetype-dev \
    libfribidi-dev libgettextpo-dev libglib2.0-dev libglibmm-2.4-dev libgtk2.0-dev libharfbuzz-dev libjack-jackd2-dev \
    liblo-dev liblrdf0-dev libnss3-dev libogg-dev libopus-dev libpango1.0-dev libpangomm-1.4-dev libpcre2-dev \
